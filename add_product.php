...
if (isset($newProduct['category'])) {
    ...
    if (!in_array($newProduct['category'], $existingCategories)) {
        $newCategoryHtml = '<div class="category" data-category="' . strtolower($newProduct['category']) . '" onclick="navigateTo(\'products\', \'' . strtolower($newProduct['category']) . '\')">
